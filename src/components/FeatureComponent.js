            ...
            <div className="row row no-gutters mb-3">
              <div className="col-lg-4 col-md-6 mt-3">
                <div className="icon-box">
                  ...
                  <div className="description">
                    Geospatial artificial intelligence combines methods in
                    spatial science (remote sensing and geographic information
                    systems or GIS), Artificial Intelligence, data mining, and
              ...
              <div className="col-lg-4 col-md-6 mt-3">
                <div className="icon-box">
                  ...
                  <div className="description">
                    Advance in technology has made geographic information
                    systems more valuable than ever. Today’s systems are more
                    powerful and more complex than their recent predecessors.
                    Professionals who depend on a GIS to help make important
                    decisions based on geospatial information.
                  </div>
                </div>
              </div>
            </div>
